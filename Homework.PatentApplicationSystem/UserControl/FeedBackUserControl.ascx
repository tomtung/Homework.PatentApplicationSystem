...
<asp:ListView ID="DataListFeedBack" runat="server">
    ...
    <ItemTemplate>
      <div class="feed">
          <span class="name"><%# ((CaseMessage)Container.DataItem).SenderUsername %></span><span class="time"></span>
          <p><%# ((CaseMessage)Container.DataItem).Content %></p>
      </div>    
    </ItemTemplate>
      ...
      <div class="comment"> 
        ...
        <button id="Button1" type="button" class="mbutton" runat="server" onserverclick="btnFinish_Click" >反馈</button>
        </div> 
     </div>
