<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CaseInfoUserControl.ascx.cs"
    Inherits="Homework.PatentApplicationSystem.UserControl.CaseInfoUserControl" %>
<asp:Table ID="tblCaseInfo" runat="server">
    ...
    <asp:TableRow CssClass="odd">
        <asp:TableCell>
            ...
            <asp:Label ID="lblClientNameInfo" runat="server" />
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
        <asp:TableCell>
